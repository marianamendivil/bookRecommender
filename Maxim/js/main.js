...
getAjax("https://www.googleapis.com/books/v1/volumes?q=:" + (path.get('subject')) + "&key=AIzaSyCbZ8Bgts91KrvGCds4KNtf_7rPaT3zhe0", function (data) {
    ...
    books.forEach(book => {
        ...
        var str = "<div class='mdc-card'><div><img src="+(thumbnail)+"></div><div class='card_primary'><h1>"+(title)+"</h1></div><div class='card_primary'><h2>"+(authorS)+"</h2></div><div class='card_primary'>"+(publishedDate)+"</div><div class='mdc-card__actions'>"+
